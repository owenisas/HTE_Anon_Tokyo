...
class SGLangCustomLogitsProcessor:
    """Callable compatible with SGLang custom logits processor style hooks."""
    ...
    def __call__(self, input_ids: Any, logits: Any) -> Any:
        context = normalize_token_ids(input_ids)
...
def build_sglang_tag_postprocessor(
